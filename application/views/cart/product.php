...
<div id="admin-container" class="" ng-controller="CartController">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-8">
                ...
                <div style="font-style: italic;">
                    ...
                    <md-button class="md-fab md-warn" aria-label="Retirer" ng-hide="can_add_to_cart(storeProduct.product.id)" ng-click="remove_product_from_cart(storeProduct.product.id)">
                        <md-icon ><i class="material-icons">remove_shopping_cart</i></md-icon>
                    </md-button>
                    
                    <md-button class="md-fab md-otiprix" aria-label="Ajouter" ng-show="can_add_to_cart(storeProduct.product.id)"  ng-click="add_product_to_cart(storeProduct.product.id, storeProduct.id)">
